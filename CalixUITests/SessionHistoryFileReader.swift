...
// (`$HOME/.calix/state/history/<id>.raw`, see
// `calix-session/crates/daemon/src/history.rs`'s `active_path`),
...
struct SessionHistoryFileReader {
    ...
    /// `$HOME/.calix/state/history/<id>.raw`. Rotation to `<id>.raw.1`
    ...
    private func activePath(id: String) -> String {
        "\(homeDir)/.calix/state/history/\(id).raw"
    }
