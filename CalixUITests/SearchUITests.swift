...
final class SearchUITests: CalixUITestCase {
    ...
    func test_openSearchBar() {
        ...
        let field = app.descendants(matching: .any)
            .matching(identifier: "calix.search.searchField")
            .firstMatch
    ...
    /// types a query into `calix.search.searchField` that matches it
    /// multiple times, and asserts `calix.search.matchCount`'s text
    ...
    func test_searchFindsSeededContent_andNextMovesSelectedMatch() {
        ...
        let matchCount = app.descendants(matching: .any)
            .matching(identifier: "calix.search.matchCount")
            .firstMatch
        ...
        // "Find Next" (calix.search.nextButton, the search bar's own
