...
final class ComposeOverlayUITests: CalixUITestCase {

    private func composeTextView() -> XCUIElement {
        app.descendants(matching: .any)
            .matching(identifier: "calix.compose.textView")
            .firstMatch
    }
    ...
    func test_placeholderHidesWhenTyping() {
        ...
        let placeholder = app.descendants(matching: .any)
            .matching(identifier: "calix.compose.placeholder")
            .firstMatch
    ...
    func test_enterSendsAndClearsText() {
        ...
        // (CalixWindowController.sendComposeText calls
        ...
        let outFile = "/tmp/calix-e2e-compose-\(ProcessInfo.processInfo.processIdentifier).txt"
