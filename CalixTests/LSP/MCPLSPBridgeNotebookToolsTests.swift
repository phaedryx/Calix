...
final class MCPLSPBridgeNotebookToolsTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/calix-mcp-lsp-bridge-notebook-A")
    private let fileA = "file:///tmp/calix-mcp-lsp-bridge-notebook-A/main.ts"
    private let notebookUri = "file:///tmp/calix-mcp-lsp-bridge-notebook-A/example.ipynb"
    private let cellOneUri = "file:///tmp/calix-mcp-lsp-bridge-notebook-A/cell-1.py"
    private let cellTwoUri = "file:///tmp/calix-mcp-lsp-bridge-notebook-A/cell-2.py"
