...
//      that path (e.g. Calix-side writes echo back through FSEvents).
...
//  `Calix/Features/LSP/FileSyncManager.swift`.
//
...
final class FileSyncManagerTests: XCTestCase {
    ...
    private func makeWorkspaceRoot(_ name: String = "ws") -> URL {
        let base = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("calix-fs-sync-\(UUID().uuidString)")
