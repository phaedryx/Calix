...
//  the live production source (Calix/Features/LSP/LSPInstaller.swift) and
//  the registry table (Calix/Features/LSP/LSPServerRegistry.swift).
//
...
//  actor exposed through `@testable import Calix`.
//
