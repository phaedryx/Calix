...
final class LSPTypesHierarchyAndMonikerTests: XCTestCase {
    ...
    func test_moniker_minimal_roundtrip() throws {
        let json = #"""
        {"identifier":"calix::foo","scheme":"calix","unique":"document"}
        """#
    ...
    func test_moniker_withKind_import_roundtrip() throws {
        let json = #"""
        {"identifier":"calix::Bar","kind":"import","scheme":"calix","unique":"global"}
        """#
        try assertRoundtrip(Moniker.self, json: json)
    }
    ...
    func test_moniker_withKind_export_roundtrip() throws {
        let json = #"""
        {"identifier":"calix::Baz","kind":"export","scheme":"calix","unique":"project"}
        """#
        try assertRoundtrip(Moniker.self, json: json)
    }
    ...
    func test_moniker_directConstruction_minimal() {
        let m = Moniker(
            scheme: "calix",
            identifier: "calix::foo",
            unique: .document,
            kind: nil
        )
        XCTAssertEqual(m.scheme, "calix")
        XCTAssertEqual(m.identifier, "calix::foo")
    ...
    func test_moniker_equatable() {
        let a = Moniker(scheme: "calix", identifier: "x", unique: .global, kind: .export)
        let b = Moniker(scheme: "calix", identifier: "x", unique: .global, kind: .export)
        let c = Moniker(scheme: "calix", identifier: "y", unique: .global, kind: .export)
        XCTAssertEqual(a, b)
