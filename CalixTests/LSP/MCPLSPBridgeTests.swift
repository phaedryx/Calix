...
//  exposes LSP requests as MCP tools to the `CalixMCPServer`.
//
...
//  `Calix/Features/LSP/MCPLSPBridge.swift` (and likely a sibling file
...
final class MCPLSPBridgeTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/calix-mcp-lsp-bridge-A")
    private let workspaceB = URL(fileURLWithPath: "/tmp/calix-mcp-lsp-bridge-B")
    private let fileA = "file:///tmp/calix-mcp-lsp-bridge-A/main.ts"
    private let fileB = "file:///tmp/calix-mcp-lsp-bridge-B/main.ts"
