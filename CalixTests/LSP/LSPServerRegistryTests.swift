...
//  15 languages Calix ships with to their launch command, auto-install
...
//  under `Calix/Features/LSP/LSPServerRegistry.swift`.
//
...
final class LSPServerRegistryTests: XCTestCase {
    ...
    // ====================================================================
    // MARK: - Codable round-trip (for ~/.config/calix/lsp.json override)
    // ====================================================================
    ...
    /// Calix into launching an attacker-controlled binary. All other
