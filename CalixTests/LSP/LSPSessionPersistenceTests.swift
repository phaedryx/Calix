...
//  JSON file under `~/Library/Application Support/Calix/lsp/sessions.json`.
//
...
//      `~/Library/Application Support/Calix/lsp/sessions.json`.
...
//  `Calix/Features/LSP/LSPSessionPersistence.swift` defining:
...
//      persistence under `Calix/Features/Persistence/SessionSnapshot.swift`).
//
...
final class LSPSessionPersistenceTests: XCTestCase {
    ...
    // ====================================================================
    // MARK: - 8. default storageURL lives under Application Support/Calix/lsp
    // ====================================================================

    /// Contract: when constructed with no argument, the actor's `storageURL`
    /// resolves under `Library/Application Support/Calix/lsp/sessions.json`.
    ...
    func test_storageURL_defaultsToApplicationSupport() {
        ...
        XCTAssertTrue(
            path.contains("Library/Application Support/Calix/lsp/sessions.json"),
            "default storage URL must live under Library/Application Support/Calix/lsp/sessions.json (got: \(path))"
        )
    }
