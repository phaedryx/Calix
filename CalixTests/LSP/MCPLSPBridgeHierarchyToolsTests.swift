...
final class MCPLSPBridgeHierarchyToolsTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/calix-mcp-lsp-bridge-hier-A")
    private let fileA = "file:///tmp/calix-mcp-lsp-bridge-hier-A/main.ts"
    ...
    func test_lspMoniker_returnsArrayOfMonikers() async throws {
        ...
        let monikersJSON = """
        [
          {"scheme":"tsc","identifier":"calix::foo","unique":"document"},
          {"scheme":"npm","identifier":"@calix/util::bar","unique":"global","kind":"export"}
        ]
        """
        ...
        XCTAssertEqual(arr[0]["identifier"] as? String, "calix::foo")
    ...
    func test_lspMoniker_validResponse_includesUniquenessAndKind() async throws {
        ...
        let monikersJSON = """
        [
          {"scheme":"calix","identifier":"calix::Bar","unique":"global","kind":"import"}
        ]
        """
        await driver.setReply(method: "textDocument/moniker", jsonResult: monikersJSON)
        ...
        XCTAssertTrue(
            content.text.contains("\"identifier\":\"calix::Bar\""),
