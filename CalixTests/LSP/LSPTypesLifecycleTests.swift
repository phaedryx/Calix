...
final class LSPTypesLifecycleTests: XCTestCase {
    ...
    func test_workspaceFolder_roundtrip() throws {
        ...
        let json = #"{"name":"calix","uri":"file:///Users/example/calix"}"#
        try assertRoundtrip(WorkspaceFolder.self, json: json)

        // Direct construction sanity check (ensures memberwise initializer exists).
        let wf = WorkspaceFolder(uri: "file:///Users/example/calix", name: "calix")
        XCTAssertEqual(wf.uri, "file:///Users/example/calix")
        XCTAssertEqual(wf.name, "calix")
    }
    ...
    func test_clientInfo_withVersion_roundtrip() throws {
        let json = #"{"name":"Calix","version":"0.26.1"}"#
    ...
    func test_initializeParams_clientInfoAndTrace_roundtrip() throws {
        ...
        {
          "capabilities":{},
          "clientInfo":{"name":"Calix","version":"0.26.1"},
          "processId":12345,
          "trace":"verbose"
        }
        """#
    ...
    func test_serverCapabilities_executeCommandProvider_roundtrip() throws {
        let json = #"""
        {"executeCommandProvider":{"commands":["calix.run","calix.format"]}}
        """#
        try assertRoundtrip(ServerCapabilities.self, json: json)
    }
    ...
    func test_serverCapabilities_experimentalField_roundtrip() throws {
        let json = #"{"experimental":{"calix":{"semverGated":true}}}"#
        try assertRoundtrip(ServerCapabilities.self, json: json)
    }
    ...
    func test_serverCapabilities_kitchenSink_roundtrip() throws {
        ...
        let json = #"""
        {
          ...
          "diagnosticProvider":{"identifier":"calix","interFileDependencies":true,"workspaceDiagnostics":false},
          ...
          "executeCommandProvider":{"commands":["calix.run"]},
          "experimental":{"calix":{"version":1}},
