...
//        lsp_workspace_apply_edit       -> Calix applies the edit locally
...
final class MCPLSPBridgeEditWorkspaceToolsTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/calix-mcp-lsp-bridge-edit-ws-A")
    private let fileA = "file:///tmp/calix-mcp-lsp-bridge-edit-ws-A/main.ts"
    ...
    func test_lspWorkspaceExecuteCommand_sendsCorrectLSPRequest() async throws {
        ...
        let args: [String: AnyCodable] = [
            "workspace_root": AnyCodable(workspaceA.path),
            "language_id": AnyCodable("typescript"),
            "command": AnyCodable("calix.organizeImports"),
        ...
        XCTAssertEqual(captured.count, 1)
        XCTAssertEqual(captured[0]["command"] as? String, "calix.organizeImports")
