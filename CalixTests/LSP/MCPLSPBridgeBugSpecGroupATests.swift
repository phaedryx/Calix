...
final class MCPLSPBridgeBugSpecGroupATests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/calix-mcp-lsp-bridge-bugA")
    private let fileA = "file:///tmp/calix-mcp-lsp-bridge-bugA/main.ts"
    ...
    func test_bug4_nonUTF8File_didOpenDispatchedOrEncodingError() async throws {
        ...
        let tmpDir = URL(fileURLWithPath: NSTemporaryDirectory())
            .appendingPathComponent("calix-bugA-\(UUID().uuidString)")
