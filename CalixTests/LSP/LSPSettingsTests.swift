...
//  `Calix/Features/LSP/LSPSettings.swift`. The `ConfirmationMode` enum is
//  already defined in `Calix/Features/LSP/LSPInstaller.swift`; the
...
final class LSPSettingsTests: XCTestCase {
    ...
    /// Calix's product decision: when a language server is missing we
