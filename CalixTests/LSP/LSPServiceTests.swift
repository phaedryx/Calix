...
//  Calix
//
//  Tests for `LSPService`, the @MainActor facade that the Calix MCP layer
...
//  until the swift-specialist creates `Calix/Features/LSP/LSPService.swift`.
//
...
final class LSPServiceTests: XCTestCase {
    ...
    private let workspaceA = URL(fileURLWithPath: "/tmp/calix-lsp-service-test-A")
    private let workspaceB = URL(fileURLWithPath: "/tmp/calix-lsp-service-test-B")
    private let workspaceC = URL(fileURLWithPath: "/tmp/calix-lsp-service-test-C")
