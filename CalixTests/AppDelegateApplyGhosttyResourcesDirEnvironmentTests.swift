...
//  `calix-session attach` as the surface command; the Rust attach client
...
//  environment already has it, and Calix never sets it today
...
//  version-mismatched resources, not Calix's own bundled, version-matched
...
//  codebase (GhosttyThemeProvider, GhosttyAction, CalixWindowController,
