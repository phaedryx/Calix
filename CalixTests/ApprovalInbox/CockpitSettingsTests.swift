...
final class CockpitSettingsTests: XCTestCase {
    ...
    private let suiteName = "com.calix.tests.CockpitSettingsTests"
    ...
    // CalixMCPServer's new POST /approval-request endpoint ever submits
    ...
    func test_agentHookApprovalEnabled_defaultFalse_andRoundTrips() {
        ...
        XCTAssertEqual(CockpitSettings.agentHookApprovalEnabledKey, "calix.cockpit.agentHookApprovalEnabled",
