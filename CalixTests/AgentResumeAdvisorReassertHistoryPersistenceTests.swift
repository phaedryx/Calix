...
//  CalixTests
//
//  TDD Red phase, P6 RED2 (R-B4): the attach-spawned calix-session
...
//  pane, by the FIRST `calix-session attach --create` ghostty actually
...
final class AgentResumeAdvisorReassertHistoryPersistenceTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.calix.tests.AgentResumeAdvisorReassertHistoryPersistenceTests"
