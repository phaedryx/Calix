...
//    that surface's cwd
//  - a .calixSurfaceDestroyed notification prunes that surface's
//    recorded title
...
final class SurfacePropertyStoreTests: XCTestCase {
    ...
    func test_surfaceDestroyed_prunesEntry() {
        ...
        NotificationCenter.default.post(name: .calixSurfaceDestroyed, object: nil, userInfo: ["surfaceID": id])
    ...
    /// destroy path -- both must post `.calixSurfaceDestroyed` so
