...
//  CalixTests
//
//  TDD Red Phase for the CalixWindowController seams Cockpit's
//  LiveCockpitAppAccess (Calix/Features/Cockpit/CockpitAppAccess.swift)
...
//  CalixWindowControllerCreateManagedSurfaceRemoteHostTests'/
...
final class CockpitAppAccessSeamTests: XCTestCase {
    ...
    private func makeController() -> (controller: CalixWindowController, tab: Tab) {
