...
//  a live calix-session process. Pumps the shared agentResumeSessionsTask
...
/// a process boundary stand-in, no real calix-session binary involved.
...
final class AgentResumeAdvisorStalenessTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.calix.tests.AgentResumeAdvisorStalenessTests"
