...
//  `@Observable` view-model, one instance owned per CalixWindowController,
...
//  keep IT independent of CalixWindowController.
//
...
//  stage.
//
//  Proposed API (new file, Calix/Features/Persistence/RecoveryBarModel.swift,
//  alongside SessionPersistenceActor.swift/SessionSnapshot.swift -- this
//  is a persistence-recovery concern, not a Sessions/calix-session-daemon
...
//    }
//
//  Wiring this needs at the AppDelegate/CalixWindowController level
...
//    must hand its new CalixWindowController a RecoveryBarModel seeded
