...
struct InstallSourceTests {
    ...
    func homebrewArmPath() {
        let source = InstallSource(
            bundleURL: URL(fileURLWithPath: "/opt/homebrew/Caskroom/calyx/0.3.5/Calix.app")
        )
    ...
    func homebrewIntelPath() {
        let source = InstallSource(
            bundleURL: URL(fileURLWithPath: "/usr/local/Caskroom/calyx/0.3.5/Calix.app")
        )
        #expect(source.source == .homebrew)
        #expect(source.isHomebrew == true)
    }
    ...
    func applicationsPath() {
        let source = InstallSource(
            bundleURL: URL(fileURLWithPath: "/Applications/Calix.app")
        )
    ...
    func randomUserPath() {
        let source = InstallSource(
            bundleURL: URL(fileURLWithPath: "/Users/test/Desktop/Calix.app")
        )
        #expect(source.source == .direct)
        #expect(source.isHomebrew == false)
    }
    ...
    func differentCaskName() {
        let source = InstallSource(
            bundleURL: URL(fileURLWithPath: "/opt/homebrew/Caskroom/other-app/1.0/Calix.app")
        )
        #expect(source.source == .direct)
        #expect(source.isHomebrew == false)
    }
