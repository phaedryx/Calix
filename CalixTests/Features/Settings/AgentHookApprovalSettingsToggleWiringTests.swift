...
//  CalixMCPServer's POST /approval-request endpoint (a CLI agent's
...
//    -- same "calix.settings.sessions.*" prefix as cockpitAutoApproveSwitch,
...
final class AgentHookApprovalSettingsToggleWiringTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.calix.tests.AgentHookApprovalSettingsToggleWiringTests"
