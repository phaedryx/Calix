...
final class CommandTrackingSettingsToggleWiringTests: XCTestCase {
    ...
    // DEBUG-only seam AppDelegateApplyCalixShellIntegrationTests uses for
    ...
    private let settingsSuiteName = "com.calix.tests.CommandTrackingSettingsToggleWiringTests"

    private var originalZdotdir: String?
    private var originalXdgDataDirs: String?
    private var originalCalixZshZdotdir: String?
    ...
    override func setUp() {
        ...
        originalCalixZshZdotdir = ProcessInfo.processInfo.environment["CALIX_ZSH_ZDOTDIR"]
    }
    ...
    override func tearDown() {
        ...
        for (name, value) in [
            ...
            ("CALIX_ZSH_ZDOTDIR", originalCalixZshZdotdir),
        ] {
            if let value {
                setenv(name, value, 1)
            } else {
