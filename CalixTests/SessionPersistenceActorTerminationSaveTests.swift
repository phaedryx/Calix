...
//  the SAME actor method CalixWindowController.windowWillClose's
...
//  instance pointed at a temp dir (CALIX_UITEST_SESSION_DIR, this
...
//  non-empty `windowControllers` array of genuine CalixWindowControllers,
...
final class SessionPersistenceActorTerminationSaveTests: XCTestCase {
    ...
    override func setUpWithError() throws {
        ...
        setenv("CALIX_UITEST_SESSION_DIR", tempDir.path, 1)
    }
