//
//  CalixWindowControllerSnapshotDelegationTests.swift
//  CalixTests
//
...
//  CalixWindowControllerSnapshotCompletenessTests (every field,
//  including sessionRefs, already covered end-to-end against a real
//  CalixWindowController).
//
//  Coverage:
...
@MainActor
final class CalixWindowControllerSnapshotDelegationTests: XCTestCase {
