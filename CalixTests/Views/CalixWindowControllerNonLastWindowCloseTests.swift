//
//  CalixWindowControllerNonLastWindowCloseTests.swift
//  CalixTests
//
...
//  (mirrors `CalixWindowControllerFullScreenTests`'s established
...
//  safety (mirrors `CalixWindowControllerCloseArmsTests`'s
...
@MainActor
final class CalixWindowControllerNonLastWindowCloseTests: XCTestCase {
