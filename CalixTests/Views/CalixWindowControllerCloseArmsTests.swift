//
//  CalixWindowControllerCloseArmsTests.swift
//  CalixTests
//
...
//  `CalixWindowController` calls `window?.close()` as part of tearing
...
@MainActor
final class CalixWindowControllerCloseArmsTests: XCTestCase {
