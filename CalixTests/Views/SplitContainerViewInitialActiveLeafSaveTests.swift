...
//  CalixWindowController.setupUI()/rebuildSplitContainer() to update
//  focusedLeafID AND call requestSave() -- see
//  CalixWindowControllerFocusSyncTests
...
//  `CalixWindowController`'s EXISTING closure wiring (unchanged --
...
//  contract exactly. It CANNOT pin that CalixWindowController's
//  production closures actually route this into `requestSave()` for a
//  REAL window (CalixWindowController cannot be instantiated with a live
