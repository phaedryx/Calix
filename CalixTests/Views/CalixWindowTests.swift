//
//  CalixWindowTests.swift
//  CalixTests
//
//  Tests for the pure helper `CalixWindow.shouldPerformZoom(pointInWindow:windowSize:titleBarHeight:trafficLightFrames:)`
...
final class CalixWindowTests: XCTestCase {
    ...
    func test_shouldPerformZoom_true_in_title_bar_away_from_traffic_lights() {
        ...
        let result = CalixWindow.shouldPerformZoom(
            pointInWindow: point,
