//
//  CalixWindowControllerFullScreenTests.swift
//  CalixTests
//
...
@MainActor
final class CalixWindowControllerFullScreenTests: XCTestCase {

    // MARK: - Helpers

    /// Build a minimal `CalixWindowController` for direct delegate invocation.
    ...
    //
    // CONSTRAINT: `isRestoring` is declared `private` on `CalixWindowController`,
