//
//  CalixWindowControllerSnapshotCompletenessTests.swift
//  CalixTests
//
...
//  through CalixWindowController.windowSnapshot(), which constructs its
...
//  the round-10 sweep: build a real CalixWindowController whose Tab
...
@MainActor
final class CalixWindowControllerSnapshotCompletenessTests: XCTestCase {
    ...
    func test_windowSnapshot_preservesEveryTabGroupAndWindowField() throws {
        ...
        let controller = CalixWindowController(window: window, windowSession: windowSession, restoring: true)

        // Representative non-default value for the isFullScreen/frame pair
        // (CalixWindowControllerFullScreenTests already covers this pair's
