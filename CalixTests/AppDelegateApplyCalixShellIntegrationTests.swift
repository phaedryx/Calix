//
//  AppDelegateApplyCalixShellIntegrationTests.swift
//  CalixTests
//
...
//  applyCalixShellIntegrationIfEnabled() directly on a bare AppDelegate(),
...
//  applyCalixShellIntegrationIfEnabled() does nothing -- so the enabled
...
@MainActor
final class AppDelegateApplyCalixShellIntegrationTests: XCTestCase {

    private let settingsSuiteName = "com.calix.tests.AppDelegateApplyCalixShellIntegrationTests"
    ...
    private func makeTempDir() throws -> URL {
        let url = FileManager.default.temporaryDirectory
            .appendingPathComponent("AppDelegateApplyCalixShellIntegrationTests-\(UUID().uuidString)")
    ...
    func test_trackingEnabled_installsAndAppliesEnv_trackingDisabled_leavesBothUntouched() throws {
        ...
        appDelegate.applyCalixShellIntegrationIfEnabled()
        ...
        secondAppDelegate.applyCalixShellIntegrationIfEnabled()
