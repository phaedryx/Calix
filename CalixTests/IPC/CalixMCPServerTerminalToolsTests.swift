//
//  CalixMCPServerTerminalToolsTests.swift
//  CalixTests
//
//  TDD Red Phase for the terminal_* MCP tool surface wired into
//  CalixMCPServer: tools/list advertises the 3 terminal_* tools, and
//  tools/call dispatches them through MCPCommandLogBridge via the
//  injected commandLogStore -- mirroring CalixMCPServerLSPIntegrationTests'
...
@MainActor
final class CalixMCPServerTerminalToolsTests: XCTestCase {
    ...
    // MARK: - Helpers (mirroring CalixMCPServerLSPIntegrationTests)
