//
//  CalixMCPServerCockpitToolsTests.swift
//  CalixTests
//
//  Covers the Cockpit MCP tool surface wired into CalixMCPServer:
...
//  mirroring CalixMCPServerTerminalToolsTests' structure at a small
...
//    not in inboxSyncToolNames), unlike a calix-ipc messaging tool call,
//    mirroring CalixMCPServerAgentEventTests' own lsp_hover exclusion test
...
@MainActor
final class CalixMCPServerCockpitToolsTests: XCTestCase {
    ...
    // MARK: - Helpers (mirroring CalixMCPServerTerminalToolsTests)
    ...
    func test_toolsCall_paneList_dispatchesToBridge_returnsPanesJSON() async throws {
        ...
        let pane = CockpitPaneInfo(
            ...
            tabTitle: "zsh", title: nil, cwd: nil, isFocused: true, agentKind: nil, calixSessionID: nil
        )
        access.panes = [pane]
    ...
    /// Mirrors `CalixMCPServerAgentEventTests
    ...
    /// NOT refresh it (unlike a calix-ipc messaging tool call, which
    ...
    // MARK: - Peer-binding helpers (mirrors CalixMCPServerAgentEventTests)
