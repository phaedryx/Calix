//
//  CalixMCPServerWiringBugSpecTests.swift
//  CalixTests
//
//  Race-safety regression tests for the `CalixMCPServer` start/stop
...
final class CalixMCPServerWiringBugSpecTests: XCTestCase {
    ...
    /// `CalixMCPServerLSPIntegrationTests.waitUntil`.
    @discardableResult
