...
//  (architecture.md §3's documented gap): Calix never sets
...
//  launch. Calix bundles its OWN version-matched copy of those scripts at
...
//  file's RED evidence.
//
//  Proposed API (Calix/GhosttyBridge/GhosttyResourcesDirResolver.swift),
...
//  directory; resourcesRoot/ghostty/shell-integration/... is Calix's own
