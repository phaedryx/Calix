...
//  CalixTests
//
//  Coverage for DemoWindowFrameArgument.parse(_:) (Calix/Helpers
...
//  (CalixUITests/DemoRecordingScenario.swift). Deliberately does not
...
final class DemoWindowFrameArgumentTests: XCTestCase {
    ...
    func test_matchAmongOtherArguments_stillParses() {
        let size = DemoWindowFrameArgument.parse([
            "/path/to/Calix", "--uitesting", "-AppleLanguages", "(en)", "--demo-window-frame=1920x1080"
        ])
