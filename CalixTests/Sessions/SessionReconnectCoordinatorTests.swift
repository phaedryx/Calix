...
//  (CalixWindowController.handleReconnectGiveUp, see
...
final class SessionReconnectCoordinatorTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.calix.tests.SessionReconnectCoordinatorTests"
    ...
    // caller (`CalixWindowController.handleReconnectGiveUp`), which
