...
//  queries the LOCAL calix-session daemon's `ls --all --json` ledger
...
//  CalixWindowController.processChildExited and every test in
...
//  `isRemote` from CalixWindowController.processChildExited via
...
final class SessionReconnectCoordinatorRemoteAwareChildExitedTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.calix.tests.SessionReconnectCoordinatorRemoteAwareChildExitedTests"
