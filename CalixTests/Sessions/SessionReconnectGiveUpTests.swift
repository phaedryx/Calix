...
//
//  Drives `CalixWindowController.handleSessionReconnectDecision
...
//  after the cap). This file covers only what `CalixWindowController`
...
final class SessionReconnectGiveUpTests: XCTestCase {
    ...
    /// `CalixWindowControllerNonLastWindowCloseTests`, see
    ...
    private final class LastPaneGiveUpMockAppDelegate: AppDelegate {
        ...
        override func closingWouldTerminate(_ controller: CalixWindowController) -> Bool {
            true
        }
        ...
        override func removeWindowController(_ controller: CalixWindowController) {}
    }
    ...
    /// `CalixWindowController._closingTabIDsForTesting` AT THE MOMENT
    ...
    func test_handleSessionReconnectDecision_deferredWhileConfirmingQuit_thenReplayedAfterGateClears() {
        ...
        // helper, `CalixTests/ReconnectFixture.swift`), not immediately.
    ...
    private final class CancelPathReplayAppDelegate: AppDelegate {
        ...
        override func closingWouldTerminate(_ controller: CalixWindowController) -> Bool { true }
    ...
    /// the snapshot (see `CalixWindowControllerNonLastWindowCloseTests`),
