//
//  CalixWindowControllerCreateManagedSurfaceRemoteHostTests.swift
//  CalixTests
//
//  P5 (remote sessions) RED phase, BUG 3 (five-angle convergence review
//  finding), contract 3b (controller level): CalixWindowController
...
@MainActor
final class CalixWindowControllerCreateManagedSurfaceRemoteHostTests: XCTestCase {

    private let settingsSuiteName = "com.calix.tests.CalixWindowControllerCreateManagedSurfaceRemoteHostTests"
