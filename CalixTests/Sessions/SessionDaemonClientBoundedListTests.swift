...
//  calix-session daemon freezes the session browser forever -- the
...
//  CalixWindowControllerFullScreenTests's header comment), it is
...
//  construction style) standing in for a calix-session subprocess that
