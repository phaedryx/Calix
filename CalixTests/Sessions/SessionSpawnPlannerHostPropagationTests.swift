...
//  CalixWindowControllerCreateManagedSurfaceRemoteHostTests, contract 3b)
...
//    - CalixWindowController.swift ~660 (createManagedSurface)
//    - CalixTests/Sessions/SessionSpawnPlannerTests.swift (3 matches)
//    - CalixTests/Sessions/SessionSpawnPlannerRemoteHostTests.swift (3 matches)
//    - CalixTests/Sessions/SessionBinaryResolverTests.swift (1 match)
...
final class SessionSpawnPlannerHostPropagationTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.calix.tests.SessionSpawnPlannerHostPropagationTests"
    ...
    func test_plan_localContext_persistentPlanCarriesNilHost() {
        ...
        let plan = SessionSpawnPlanner.plan(for: context, resolver: FakeBinaryResolver(path: "/dummy/calix-session"))
    ...
    func test_plan_remoteHostQuickTerminalOrigin_stillPassthrough_noHostToPropagate() {
        ...
        XCTAssertEqual(SessionSpawnPlanner.plan(for: context, resolver: FakeBinaryResolver(path: "/dummy/calix-session")), .passthrough,
