...
//  `CalixWindowController.setupCommandRegistry` alongside
...
//  concern), CalixWindowController.remoteSessionSpawnContext(forHost:)
...
//  CalixWindowController yet, and no `session.newRemote` command is
...
final class SessionCommandPaletteNewRemoteTests: XCTestCase {
    ...
    private let settingsSuiteName = "com.calix.tests.SessionCommandPaletteNewRemoteTests"
