...
// CalyxWindowController: sidebar visibility/monitoring, commit-log
...
// mutations here are visible to CalyxWindowController without any
// forwarding. `refresh` wraps CalyxWindowController.refreshHostingView()
...
// stays owned by CalyxWindowController; `sendToAgent` wraps
