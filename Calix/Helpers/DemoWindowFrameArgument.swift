...
// product-demo XCUITest scenario (CalixUITests/DemoRecordingScenario.swift),
...
// CalixWindowController's own 800x600-then-center() default would produce.
//
...
// the caller" split -- so CalixTests can cover every malformed shape
