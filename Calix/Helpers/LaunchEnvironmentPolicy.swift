...
// Calix
//
// Decides whether this process is the CalixTests unit-test host, so
// AppDelegate can gate its production launch body off of the developer's
// real ~/.calix environment. Sibling to TestEnvironment.swift and reuses
...
// (CalixUITests launches it with "--uitesting" instead), so that process
