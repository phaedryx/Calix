...
// `Calix/Helpers/SettingsStore.swift`'s header comment for the full
...
struct SessionSettings: Sendable {
    ...
    static let persistentSessionsEnabledKey = "calix.session.persistentSessionsEnabled"
    static let agentResumeEnabledKey = "calix.session.agentResumeEnabled"
    static let agentResumeAutoExecuteKey = "calix.session.agentResumeAutoExecute"
    static let historyPersistenceEnabledKey = "calix.session.historyPersistenceEnabled"
