...
// calix-agent-hook script can always reach the current IPC server, even
...
enum AgentEndpointFile {
    ...
    /// Default directory: `~/Library/Application Support/Calix`.
    ...
    /// `calix-agent-hook` script, invoked concurrently from every active
