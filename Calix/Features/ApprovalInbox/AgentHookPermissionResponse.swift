...
// Calix
//
// The PreToolUse hook stdout body Calix writes back to a CLI agent to
...
// Calix must never inject a permission decision into a CLI hook
...
enum AgentHookPermissionResponse {
    ...
    private static func permissionDecisionReason(for permissionDecision: String) -> String {
        ...
        case "allow": return "Approved from the Calix approval inbox."
        case "deny": return "Denied from the Calix approval inbox."
