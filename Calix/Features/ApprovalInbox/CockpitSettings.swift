...
struct CockpitSettings: Sendable {
    ...
    static let autoApproveEnabledKey = "calix.cockpit.autoApproveEnabled"
    ...
    static let agentHookApprovalEnabledKey = "calix.cockpit.agentHookApprovalEnabled"

    /// Gates whether `CalixMCPServer`'s `POST /approval-request` endpoint
