...
actor LSPSession {
    ...
    init(
        ...
        languageId: String,
        client: LSPClient,
        clientCapabilities: ClientCapabilities = ClientCapabilities.calixDefault(),
    ...
    private func installServerRequestHandlers() async {
        ...
        // feature below (see `ClientCapabilities.calixDefault()`), which
...
// MARK: - ClientCapabilities.calixDefault

extension ClientCapabilities {
    /// Calix default: declares support for the full surface that
    ...
    static func calixDefault() -> ClientCapabilities {
