...
//          true                  false         .silent
//
//  Both knobs default to `true` on first launch: Calix attempts auto-install
...
struct LSPSettings: Sendable {
    ...
    static let autoInstallEnabledKey = "calix.lsp.autoInstallEnabled"
    static let requireInstallConfirmationKey = "calix.lsp.requireInstallConfirmation"
