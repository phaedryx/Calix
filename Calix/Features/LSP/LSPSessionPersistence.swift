...
//  file under `~/Library/Application Support/Calix/lsp/sessions.json` so the
...
actor LSPSessionPersistence {
    ...
    /// window/tab persistence under `Calix/Features/Persistence/`.
    ...
    ///   `~/Library/Application Support/Calix/lsp/sessions.json` (resolved
