...
class SettingsWindowController: NSWindowController {
    ...
    private func sectionHeading(for row: SettingsRow) -> SectionHeading? {
        ...
        case .lspAutoInstall:
            return SectionHeading(
                title: "Auto-Install",
                subtitle: "Calix hosts language servers and exposes them to AI agents over MCP. When a server is missing, Calix can install it automatically."
            )
    ...
    private func showConfigFileError(_ error: ConfigFileOpenError, opener: SystemConfigFileOpener) {
        ...
        case .isSymlink:
            alert.informativeText = "The config path is a symbolic link. For security, Calix will not follow symlinks."
    ...
    /// (`CalixShellIntegrationEnvironment.remove`); the `/command-event`
...
private final class GhosttyConfigHelpViewController: NSViewController {
    ...
    override func loadView() {
        ...
        let subtitle = NSTextField(wrappingLabelWithString: "Calix reads ~/.config/ghostty/config. Most settings are hot-reloaded when you save the file.")
        ...
        let managedLabel = NSTextField(wrappingLabelWithString: "The following keys are managed by Calix for the Glass UI effect and will be overridden:")
