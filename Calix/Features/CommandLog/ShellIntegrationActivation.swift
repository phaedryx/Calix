...
// Calix
//
// Shared install-then-apply sequencing for Calix's own shell
// integration, used by both AppDelegate.applyCalixShellIntegrationIfEnabled()
...
private let logger = Logger(subsystem: "com.calix.terminal", category: "ShellIntegrationActivation")

enum ShellIntegrationActivation {

    /// Installs Calix's own zsh/fish integration scripts into `root`,
