// CalixShellIntegrationEnvironment.swift
// Calix
//
...
enum CalixShellIntegrationEnvironment {
    static let zdotdirVariableName = "ZDOTDIR"
    static let originalZdotdirVariableName = "CALIX_ZSH_ZDOTDIR"
    ...
    /// PRE-EXISTING ZDOTDIR is preserved into CALIX_ZSH_ZDOTDIR first --
    ...
    /// CALIX_ZSH_ZDOTDIR (or unsets it if none was saved) and removes
    ...
    /// two. CALIX_ZSH_ZDOTDIR itself is always cleared, regardless of
