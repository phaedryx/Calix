...
private let logger = Logger(subsystem: "com.calix.terminal", category: "GhosttySurface")
...
final class GhosttySurfaceController: Identifiable {
    ...
    init?(app: ghostty_app_t, baseConfig: ghostty_surface_config_s, view: SurfaceView) {
        ...
        // Inject CALIX_SURFACE_ID so the calix-agent-hook script (installed
        ...
        // with CALIX_SURFACE_ID prepended.
        ...
        let envKeys = ["CALIX_SURFACE_ID"] + existingEnvKeys
...
private extension Array where Element == String {
    ...
    /// project/target and isn't reusable from Calix.
    ///
