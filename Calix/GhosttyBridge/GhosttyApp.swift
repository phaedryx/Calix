...
private let logger = Logger(subsystem: "com.calix.terminal", category: "GhosttyApp")
...
private func ghosttyReadClipboardCallback(
    ...
    MainActor.assumeIsolated {
        ...
        case GHOSTTY_CLIPBOARD_SELECTION:
            ...
            pasteboard = .init(name: .init("com.calix.selection"))
        default:
            pasteboard = .general
        }
...
extension Notification.Name {
    static let ghosttyCloseSurface = Notification.Name("com.calix.ghostty.closeSurface")
    static let ghosttyNewWindow = Notification.Name("com.calix.ghostty.newWindow")
    static let ghosttyNewTab = Notification.Name("com.calix.ghostty.newTab")
    static let ghosttyNewSplit = Notification.Name("com.calix.ghostty.newSplit")
    static let ghosttyCloseTab = Notification.Name("com.calix.ghostty.closeTab")
    static let ghosttyCloseWindow = Notification.Name("com.calix.ghostty.closeWindow")
    static let ghosttySetTitle = Notification.Name("com.calix.ghostty.setTitle")
    static let ghosttyPromptTabTitle = Notification.Name("com.calix.ghostty.promptTabTitle")
    static let ghosttySetPwd = Notification.Name("com.calix.ghostty.setPwd")
    static let ghosttyCellSizeChange = Notification.Name("com.calix.ghostty.cellSizeChange")
    static let ghosttyInitialSize = Notification.Name("com.calix.ghostty.initialSize")
    static let ghosttySizeLimit = Notification.Name("com.calix.ghostty.sizeLimit")
    static let ghosttyConfigChange = Notification.Name("com.calix.ghostty.configChange")
    static let ghosttyColorChange = Notification.Name("com.calix.ghostty.colorChange")
    static let ghosttyToggleFullscreen = Notification.Name("com.calix.ghostty.toggleFullscreen")
    static let ghosttyRendererHealth = Notification.Name("com.calix.ghostty.rendererHealth")
    static let ghosttyRingBell = Notification.Name("com.calix.ghostty.ringBell")
    static let ghosttyShowChildExited = Notification.Name("com.calix.ghostty.showChildExited")
    static let ghosttyGotoSplit = Notification.Name("com.calix.ghostty.gotoSplit")
    static let ghosttyResizeSplit = Notification.Name("com.calix.ghostty.resizeSplit")
    static let ghosttyEqualizeSplits = Notification.Name("com.calix.ghostty.equalizeSplits")
    static let ghosttyDesktopNotification = Notification.Name("com.calix.ghostty.desktopNotification")
    static let ghosttyStartSearch = Notification.Name("com.calix.ghostty.startSearch")
    static let ghosttyEndSearch = Notification.Name("com.calix.ghostty.endSearch")
    static let ghosttySearchTotal = Notification.Name("com.calix.ghostty.searchTotal")
    static let ghosttySearchSelected = Notification.Name("com.calix.ghostty.searchSelected")
    static let ghosttyGotoTab = Notification.Name("com.calix.ghostty.gotoTab")
    static let ghosttyConfirmClipboard = Notification.Name("com.calix.ghostty.confirmClipboard")
    ...
    static let ghosttyProgressReport = Notification.Name("com.calix.ghostty.progressReport")
    static let smoothScrollSettingChanged = Notification.Name("com.calix.smoothScrollSettingChanged")
}
