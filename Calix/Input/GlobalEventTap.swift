...
private let logger = Logger(subsystem: "com.calix.terminal", category: "GlobalEventTap")
...
/// events before AppKit's menu-key-equivalent routing runs. When Calix itself
...
private func globalKeyEventHandler(
    ...
    // When Calix is the active application, let standard menu key equivalents
