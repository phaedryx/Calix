...
struct AgentStatusView: View {
    var body: some View {
        content
            ...
            // `CalixWindowController`'s screen-classification poll can
    ...
    private var content: some View {
        Group {
            ...
            // CalixMCPServer.isRunning: CalixMCPServer is a plain
    ...
    /// (`AgentRegistry.hooksIssues`, set by `CalixWindowController.
